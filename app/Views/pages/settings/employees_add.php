               ...
               <div class="card">
                  <div class="card-content collapse show">
                     <div class="card-body card-dashboard" >
                         ...
                         ?>
                        <form method="post" enctype="multipart/form-data" action="<?= base_url('post-employee-data') ?>" id="employee_form">
                           <input type="hidden" name="action" id="action" value="post-employee-data">
                           ...
                           <input type="hidden" name="profile_image_name" id="imagePreview_name" value="">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-floating">
                                      <select class="select2 form-control emp-store_id" name="store_id[]" id="store_id" multiple="multiple">
                                      ...
                                      <label for="floatingSelectGrid">Stores</label>
                                    </div>
                                 </div>
                                 <div class="col-md-3">
                                    <div class="form-floating">
                                      <select class="select2 form-control terminal_id" id="terminal_id" name="terminal_id[]" aria-label="Floating label select example" multiple="multiple">
                                          <option disabled>Select Terminals</option>
                                          <?php if(!empty($data['terminals'])){
                                       ...
                                       <label for="floatingSelectGrid">Terminals</label>
                                    </div>
                                 </div>
                                  <div class="col-md-3">
                                    <div class="form-floating">
