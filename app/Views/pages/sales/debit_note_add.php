      ...
      <form method="post" id="invoice_form" name="invoice_form">
        <div class="card">
          <div class="card-body">
            ...
            <input type="hidden" name="table_name" id="table_name" value="sell_orders">
            <input type="hidden" name="id" id="id" value="">
            <input type="hidden" name="invoice_type" value="2">
            <input type="hidden" name="main_invoice_id" value="<?=isset($value['id'])?$value['id']:''?>">
            ...
            <div class="row g-4">
              ...
              <div class="col-md">
                 <?php $debit_note = $data['debitnote']+1; ?>
                 <div class="form-floating">
                    <input type="text" class="form-control" id="debit" name="debit" placeholder="Debit Note" value="<?= isset($value['id'])?$value['id']:$debit_note ;?>">
                    <label for="floatingSelectGrid">Debit Note*</label>
                 </div>
              </div>
              <div class="col-md">
                 <div class="form-floating">
                    <?php
                     $order_number = date('Y').'AIDE0'.$debit_note; ?>
                    <input type="text" class="form-control" id="" name="order_number" placeholder="Order Number" value="<?= isset($value['id'])?$value['order_number']:$order_number;?>">
                    <label for="floatingSelectGrid">Order Number*</label>
                 </div>
              </div>
              <div class="col-md">
                 <div class="form-floating">
                    <input type="Date" class="form-control" id="invoice_date" name="invoice_date" placeholder="Debit Note Date" value="<?= isset($value['invoice_date'])?$value['invoice_date']:''?>">
                    <label for="floatingSelectGrid">Debit Note Date</label>
                 </div>
              </div>
            </div>
            <br>
            <div class="row g-4">
                ...
                <div class="col-md-3">
                   <div class="form-floating">
                      <input type="date" class="form-control" id="due_date" name="due_date" placeholder="Due Date" value="">
                         ...
                         <select class="form-select" onchange="$('#currency_rate').val($(this).find(':selected').attr('data-rate'))" name="currency_id" id="currency_id" aria-label="Floating label select example">
                          ...
                          <?php 
                            if(!empty($data['currency']))
                            {
                              ...
                              { ?>
                                 <option data-rate="<?= $row['exchange_rate']?>" value="<?= $row['id']?>"><?=$row['currency_code']?> (<?=$row['currency_symbol']?>) - <?=$row['currency_name']?></option>
                                <?php
                              }
                            } 
                          ?>
                ...
                <div class="col-md-3 curr-row d-none">
                  <div class="form-floating">
                    <input type="text" class="form-control" name="currency_rate" id="currency_rate" value="" placeholder="Currency Rate">
            ...
            <!-- <div class="row g-1">
              <div class="col-md-3" id="invoice_type">
                <div class="form-floating">
                  <select class="form-select"  name="invoice_type"  aria-label="Floating label select example">
                     <option value="">Select</option>
                     <option <?= isset($value['invoice_type']) && ($value['invoice_type'] == 1) ?"selected":"";?> value="1">Credit Note</option>
                     <option <?= isset($value['invoice_type']) && ($value['invoice_type'] == 2)?"selected":"";?> value="2">Debit Note</option>
                  </select>
                                ...
                                <table id="sellItemTable" class="table table-bordered module-items-tbl">
                                   ...
                                   <tbody>
                                       ...
                                       <tr class="new-row">
                                            ...
                                            <td colspan="2">
                                               <select class="form-control form-select select2 item-add item_id-sales text-left" data-tab="sell" name="items[1][item_id]">
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="row" style="border-top: 1px solid #bcbcbc;border-bottom: 1px solid #bcbcbc;">
                                           ...
                                           <div class="col-md-4 conv-currency" style="visibility: hidden;">
                                              <span class="currdiscountAmount">0.00</span>
                                              <input type="hidden" value="0.00" name="currency_discount" id="curr-total-discount">
                                           </div>
                                           <div class="col-md-4">
                                              <span class="discountAmount">0.00</span>
                                              <input type="hidden" value="0.00" name="total_discount" id="total-discount">
                                           </div>
                                        </div>
                                       <div class="row">
                                             <div class="col-md-4">
                                             ...
                                             <div class="col-md-4 conv-currency" style="visibility: hidden;">
                                                <!-- <span class="conv-curr-symbol f-w-600"></span> --><span class="subCurrTotal">0.00</span>
                                                <input type="hidden" value="0.00" name="sub_curr_total" id="sub-curr-total">
                                             </div>
                                             <div class="col-md-4">
                                                <span class="subTotal">0.00</span>
                                                <input type="hidden" value="0.00" name="sub_total" id="sub-total">
                                             </div>
                                        </div>
                                        <div class="row">
                                           <div class="col-md-4">
                                           ...
                                           <div class="col-md-4 conv-currency" style="visibility: hidden;">
                                              <span class="currTax">0.00</span>
                                                <input type="hidden" value="0.00" name="currency_tax" id="curr-tax">
                                           </div>
                                           <div class="col-md-4">
                                              <span class="taxAmount">0.00</span>
                                              <input type="hidden" value="0.00" name="total_tax" id="total-tax">
                                           </div>
                                        </div>
                                        <div class="row">
                                          <div class="col-md-4">
                                        ...
                                        <div class="row form-footer-right">
                                          ...
                                          <div class="col-md-5">
                                            <div class="d-flex">
                                              ...
                                              <span><input type="text" class="form-control form-border" name="total_amount" id="total-amount" value="0.00" readonly></span></div>
                                          </div>
                                        </div>
