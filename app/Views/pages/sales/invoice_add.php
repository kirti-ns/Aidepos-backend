        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row g-4">
              ...
              <div class="col-md">
                 <?php $invoice_number = count($data['invoice'])+1; ?>
                 <div class="form-floating">
                    <input type="text" class="form-control" id="invoice" name="invoice" placeholder="Invoice" value="<?= isset($value['id'])?$value['id']:$invoice_number ;?>">
              ...
              <div class="col-md">
                 <div class="form-floating">
                    <?php
                     $order_number = date('Y').'AIDE0'.$invoice_number; ?>
              ...
              <div class="col-md">
                 <div class="form-floating">
                    <input type="Date" class="form-control" id="invoice_date" name="invoice_date" placeholder="Invoice Date" value="<?= isset($value['invoice_date'])?$value['invoice_date']:''?>">
            ...
            <div class="row g-4">
                ...
                <!-- <div class="col-md">
                   ...
                   <div class="form-floating">
                      <select  class="form-select" name="payment_status" id="payment_status" aria-label="Floating label select example">
                         <option  value="">Select</option>
                         
                         <option  <?= isset($value['payment_status']) && ($value['payment_status'] == '0')?'selected':''?> value="0">Paid</option>
                         <option  <?= isset($value['payment_status']) && ($value['payment_status'] == '1')?'selected':''?> value="1">Unpaid</option>
                         <option  <?= isset($value['payment_status']) && ($value['payment_status'] == '2')?'selected':''?> value="2">Cancelled</option>
                         
                      </select>
                      <label for="floatingInputGrid">Payment Status </label>
                   </div>
                   <?php }?>
                </div> -->
                ...
                <div class="col-md-3">
                   <div class="form-floating">
                      <select class="form-select" name="payment_mode" id="payment_mode" aria-label="Floating label select example" >
                            <option value="">Select</option>
                          <?php 
                               if(!empty($data['payment_mode']))
                               {
                                  foreach($data['payment_mode'] as $row)
                                     { ?>
                                        <option <?= isset($value['payment_mode']) && ($value['payment_mode'] == $row['id'])?'selected':''?> value="<?= $row['id']?>"><?= $row['payment_type']?></option>
                               <?php
                                     }
                                } 
                               ?>
                           ...
                           <div class="card-content collapse show">
                              <div class="card-body">
                                <table id="sellItemTable" class="table table-bordered module-items-tbl">
                                   ...
                                   <tbody>
                                      <input type="hidden" name="count" id="item-count" value="<?= isset($data['sell_items'])?count($data['sell_items']):0 ?>">
