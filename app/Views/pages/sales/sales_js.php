<script>
  function addSellItem (argument) {
   ...
   var id = 'item_id-sales'+t1;
    ...
    $('<input class="discount form-control form-border " type="number" name="items['+t1+'][discount]" value="">&nbsp;<select class="form-control form-border discount_type form-select" name="items['+t1+'][discount_type]"><option value="%">%</option><option value="ZMW">ZMW</option></select><input class="discount_amount form-control" type="hidden" name="items['+t1+'][discount_amount]" value="0.00">').appendTo(cell5);
