...
<div class="app-content content">
  ...
  <?= view('includes/breadcrumb.php');?>
    ...
    <?php $value = isset($data['quote'])?$data['quote']:"";?>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row g-4">
              ...
              <div class="col-md">
                 <?php $invoice_number = $data['invoice']; ?>
                 <div class="form-floating">
                    <input type="text" class="form-control" id="invoice" name="invoice" placeholder="Invoice" value="<?= isset($invoice_number)?$invoice_number:'' ;?>">
              ...
              <div class="col-md">
                 <div class="form-floating">
                    ...
                    <input type="text" class="form-control" id="" name="order_number" placeholder="Order Number" value="<?= $order_number;?>">
                    <label for="floatingSelectGrid">Order Number*</label>
                 </div>
              </div>
              <div class="col-md">
                 <div class="form-floating">
                    <input type="Date" class="form-control" id="invoice_date" name="invoice_date" placeholder="Invoice Date" value="<?= isset($value['invoice_date'])?$value['invoice_date']:date('Y-m-d')?>">
                           ...
                           <div class="card-content collapse show">
                              <div class="card-body">
                                <table id="sellItemTable" class="table table-bordered module-items-tbl">
                                   ...
                                   <tbody>
                                      <input type="hidden" name="count" id="item-count" value="<?= isset($data['quote_items'])?count($data['quote_items']):0 ?>">
