                ...
                <section class="mb-1 filter-bar">
                    ...
                    <div class="btn-group mr-1 mb-1">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item export-report" href="javascript:void(0);" data-type="stock-valuation" data-file="pdf">PDF</a>
                            <a class="dropdown-item export-report" href="javascript:void(0);" data-type="stock-valuation" data-file="csv">CSV</a>
                            <a class="dropdown-item export-report" href="javascript:void(0);" data-type="stock-valuation" data-file="xlsx">Excel</a>
                        </div>
                    </div>
                </section>
            </form>
