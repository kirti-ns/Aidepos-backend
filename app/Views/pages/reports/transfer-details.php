    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-8 col-12 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Tranfer Details</h3>
            </div>
        </div>
                ...
                <section class="mb-1 filter-bar">
                    ...
                    <div class="btn-group mr-1 mb-1">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item export-report" href="javascript:void(0);" data-type="transfer-details" data-file="pdf">PDF</a>
                            <a class="dropdown-item export-report" href="javascript:void(0);" data-type="transfer-details" data-file="csv">CSV</a>
                            <a class="dropdown-item export-report" href="javascript:void(0);" data-type="transfer-details" data-file="xlsx">Excel</a>
                        </div>
                    </div>
                </section>
            </form>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-content collapse show">
                                        <div class="card-body card-dashboard">
                                            <table id="report-transfer-details" class="table table-striped table-bordered">
                                                <thead>
                                                    <tr>
                                                        <th>Transfer No</th>
                                                        <th>Supply Store</th>
