...
<div class="app-content content">
         <div class="content-wrapper">
            ...
            <div class="content-body">
               <?php $value = "";?>
               <form method="post" id="direct_goods_receive_form" action="<?= base_url('post_data_purchase') ?>" name="direct_goods_receive_form">
                  <div class="card">
                     <div class="card-body">
                        <input type="hidden" name="action" id="action" value="post_data_purchase">
                        <input type="hidden" name="table_name" id="table_name" value="direct_goods_received">
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-md-3">
                            <div class="form-floating">
                                 <input type="date" class="form-control" id="date" name="received_date" placeholder="Date" value="<?= isset($value['date'])?$value['date']:date('Y-m-d');?>">
                                 <label for="floatingInputGrid">Received Date</label>
                              </div>
                           </div>
                        </div>
                        <br>
                                 ...
                                 <div class="card">
                                    <div class="card-content collapse show">
                                       <div class="card-body">
                                          ...
                                          <div class="row">
                                             <div class="col-md-5">
                                                <textarea placeholder="Notes" name="notes" rows="4" cols="50" class="form-control"><?= isset($value['received_note']) ? $value['received_note'] : '' ?></textarea>
                                             </div>
