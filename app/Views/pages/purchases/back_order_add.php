...
<div class="app-content content">
         <div class="content-wrapper">
            ...
            <div class="content-body">
               <?php $value = isset($data['back_order'])?$data['back_order']:"";?>
               <form method="post" id="purchase_back_order_form" action="<?= base_url('post_data_purchase') ?>" name="purchase_back_order_form">
                  <div class="card">
                     <div class="card-body">
                        <input type="hidden" name="action" id="action" value="post_data_purchase">
                        <input type="hidden" name="table_name" id="table_name" value="back_order">
                                                      ...
                                                      <tbody>
                                                        <?php
                                                         ...
                                                         if(isset($data['purchaseitems']) && !empty($data['purchaseitems'])) { 
                                                            ...
                                                            <td>
                                                               <input class="discount form-control" type="number" name="items[<?= $k+1; ?>][discount]" value="<?= $row['discount']; ?>">&nbsp;<select class="form-control discount form-select" name="items[<?= $k+1; ?>][discount_type]"><option value="%" <?php $row['discount_type'] == '%' ? 'selected' : '' ?>>%</option><option value="ZMW" <?php $row['discount_type'] == 'ZMW' ? 'selected' : '' ?>>ZMW</option></select><input class="discount_amount form-control" type="hidden" name="items[<?= $k+1; ?>][discount_amount]" value="<?= $row['discount_amount']; ?>">
                                                            </td>
                                                            ...
                                                            <td>
                                                              <!-- <a href="#" data-table="purchaseorders" data-id="<?= $row['id']?>" class="transh-icon-color item-remove" title="Remove"><i class="fa fa-trash-o"></i></a> -->
                                                            </td>
                                                            </tr>
                                                         <?php }
                                                          } else { ?> 
