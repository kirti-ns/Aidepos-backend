...
?>
     ...
     <!--  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i%7CMuli:300,400,500,700" rel="stylesheet"> -->
      ...
      <!-- Daterange for Reports -->
      <link rel="stylesheet" type="text/css" href="<?= base_url()?>public/app-assets/vendors/css/pickers/daterange/daterangepicker.css?v=1.2">
      ...
      <link rel="stylesheet" type="text/css" href="<?= base_url()?>public/bootstrap-tagsinput.css">
...
<!-- Sales Start -->
       ...
       <style type="text/css">
        ...
        .dataTables_wrapper div.col-sm-12 {
         ...
         .dataTables_wrapper div.col-sm-12::-webkit-scrollbar {
             width: 5px;
         }
          .dataTables_wrapper div.col-sm-12::-webkit-scrollbar:horizontal {
             height: 5px;
         }
          .dataTables_wrapper div.col-sm-12::-webkit-scrollbar-track {
             background-color: #eee;
         }
          .dataTables_wrapper div.col-sm-12::-webkit-scrollbar-thumb {
             border-radius: 10px;
             background: #999;
         }
       </style>
