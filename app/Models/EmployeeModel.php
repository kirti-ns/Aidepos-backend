...
class EmployeeModel extends Model
{
    ...
    protected $allowedFields    = ['first_name','last_name','role_id','primary_email','country_code','phone','secondary_email','address','zip','city','password','store_id','forgot_password_token','status','state','country','time_zone','language','gender','nick_name','profile'];
