!function(a,e,m){"use strict";m.app=m.app||{};var dashboard="",u=m("body"),d=m(a),l=m('div[data-menu="menu-wrapper"]').html(),r=m('div[data-menu="menu-wrapper"]').attr("class");m.app.menu={expanded:null,collapsed:null,hidden:null,container:null,horizontalMenu:!1,manualScroller:{obj:null,init:function(){var e=m(".main-menu").hasClass("menu-dark")?"light":"dark";this.obj=m(".main-menu-content").perfectScrollbar({suppressScrollX:!0,theme:e})},		update:function(){if(this.obj){var e;
